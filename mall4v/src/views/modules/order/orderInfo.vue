              ...
              <div class="state-title">
                <el-form-item label="订单状态:">
                  <template slot-scope="scope">
                    ...
                    <el-tag v-if="dataForm.status === 2 && dataForm.orderType !== 1"
                            size="small"
                            type="warning">待发货</el-tag>
                    <el-tag v-if="dataForm.status === 3 && dataForm.orderType !== 1"
                            size="small"
                            type="warning">待收货</el-tag>
                    <el-tag v-if="dataForm.status === 4 && dataForm.orderType !== 1"
                            size="small"
